...
void Back_Fireplace_DrawFG(StageBack *back)
{
	Back_Fireplace *this = (Back_Fireplace*)back;
...
void Back_Fireplace_DrawBG(StageBack *back)
{
	Back_Fireplace *this = (Back_Fireplace*)back;
...
void Back_Fireplace_Free(StageBack *back)
{
	Back_Fireplace *this = (Back_Fireplace*)back;
...
StageBack *Back_Fireplace_New(void)
{
	//Allocate background structure
	Back_Fireplace *this = (Back_Fireplace*)Mem_Alloc(sizeof(Back_Fireplace));
	if (this == NULL)
		return NULL;
	
	//Set background functions
	this->back.draw_fg = Back_Fireplace_DrawFG;
	this->back.draw_md = NULL;
	this->back.draw_bg = Back_Fireplace_DrawBG;
	this->back.free = Back_Fireplace_Free;
	
	//Load background textures
	IO_Data arc_back = IO_Read("\\PSYCHE\\FPLACE.ARC;1");
